...
ALL_METHODS: List[Method] = [
    ...
    Method(3,  1, "Поворот",               "Поворачивает картинку на небольшой угол",            PARAM_INTENSITY, True,  5, 100),
    Method(4,  1, "Наклон",                "Наклоняет картинку вбок, как если камера чуть криво", PARAM_INTENSITY, True,  5, 100),
    Method(5,  1, "Обрезка краёв",         "Срезает края видео со всех сторон",                  PARAM_INTENSITY, True,  5, 100),
    Method(6,  1, "Зум",                   "Приближает картинку (как зум на камере)",            PARAM_INTENSITY, True,  5, 100),
    Method(7,  1, "Сдвиг картинки",        "Двигает картинку влево/вправо/вверх/вниз",          PARAM_INTENSITY, True,  5, 100),
    Method(8,  1, "Перспектива",           "Как будто смотришь на экран чуть сбоку",             PARAM_INTENSITY, False, 5, 100),
    Method(9,  1, "Чёрные полосы",         "Добавляет полосы сверху/снизу (как в кино)",         PARAM_INTENSITY, True,  5, 100),
    Method(69, 1, "3D сдвиг ←→",          "Как будто камера сдвинулась влево или вправо",       PARAM_INTENSITY, True,  5, 100),
    Method(70, 1, "3D сдвиг ↑↓",          "Как будто камера сдвинулась вверх или вниз",         PARAM_INTENSITY, True,  5, 100),
